...
1. Use 'Zoom' so that you're comfortable with the size of the 'theatre of operation'.

2. Slow 'ticks' to a very slow rate!

3. Press the 'mine' button to randomly distribute the mines around the theatre of operation in clusters to your liking!

4. Press the 'deploy' button to place the bots at the centre of the theatre.

5. Press 'march' to commence the exercise! (Press it again to stop the advance).

6. Press 'retreat' to return the bots to base. (Press it again to stop the retreat).
